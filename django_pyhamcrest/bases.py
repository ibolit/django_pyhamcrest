...
from django_pyhamcrest.util import get_mismatch_description
...
class MultisegmentMatcher(BaseMatcher):
    """Makes use of the ComponentMatcher.
    ...
    def describe_mismatch(self, item, mismatch_description):
        m_desrs = [get_mismatch_description(m, item) for m in self.matchers]
